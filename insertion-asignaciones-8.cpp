...
int main()  
{  
	 const int n=8; //numero de valores del arreglo
    int arr[n];  
	 for(int i=1;i<=n;i++){
		arr[i-1]=n-i+1;
	 }
	 ...
	 cout<<"Para "<<n<<" se realizan todas estas asignaciones: "<<endl;
    ...
    insertionSort2(arr, nn);
	 ...
	 cout<<"Lo que representa la sumatoria de los (n-2) primeros numeros"<<endl; 
